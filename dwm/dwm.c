...
struct Client {
	...
	/* bool? */
	int wasfloating, isfixed, iscentered, isfloating, isurgent, neverfocus, oldstate, isfullscreen;
	Client *next;
	Client *snext;
	Monitor *mon;
	Window win;
...
void on_start(void) {
		...
		borderpx = BORDER_PX;
		system("/bin/sh ${HOME}/Scripts/startup.sh &");
}
